...
function convertTemperature(temp, con) {
  if (con === 'C') {
    return (temp * 9/5) + 32;
  } else if (con === 'F') {
    return (temp - 32) * 5/9;
  } else {
    return 'Use Celcius or Farenheit'
  }
}
...
function basicCalculator(n1, n2, calculate) {
...
Challenge yourself with numArgs. 
This function should return the count of arguments 
